// 下面这段代码是一种常见的 JavaScript 混淆/解混淆模板，
// 用于隐藏真实的字符串和功能，增强逆向难度。


// 1. 初始化数据数组和滚动混淆
var ynfqt = '__0x2fb9f'
    // __0x2fb9f 初始化为 Base64 编码后的字符串数组。
    ,
...
// 自执行函数将其循环移动 0x81（129）次，打乱顺序。这是为了防止固定索引被轻易识别。
...
var _0x2246 = function (_0x5c2ba4, _0x76e2e) {
    ...
    if (_0x2246['initialized'] === undefined) {
        // 初始化 atob 和 rc4 解密机制
        // atob 填充 + RC4 解密函数 rc4()
        // atob()：用于将 Base64 编码字符串解码为原始字节串
        // rc4()：常见流密码算法，用于 “key” 解密初始 data 数组内容。
        (function () {
